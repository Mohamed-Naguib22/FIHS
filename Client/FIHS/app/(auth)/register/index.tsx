...
import { Button, ButtonText,View ,Text, HStack, VStack, Input, ImageBackground, FormControl,} from '@gluestack-ui/themed'
              ...
              <VStack gap={'$1.5'} mx={'$1.5'}>
                ...
                </View>
                {
                    ...
                    <HStack gap={'$1'} my={'$1.5'} mx={'$3'}>
                      ...
                      <Text size='xs' color='$textLight200'>{errors.firstName}</Text>
                    </HStack>
                }
              </VStack>
              <VStack gap={'$1.5'} mx={'$1.5'}>
              <View marginTop={12}>
              ...
              </View>
                {
                  ...
                  <HStack gap={'$1'} my={'$1.5'} mx={'$3'}>
                    ...
                    <Text size='xs' color='$textLight200'>{errors.lastName}</Text>
                  </HStack>
                }
              </VStack>
              <VStack gap={'$1.5'} mx={'$1.5'}>
              <View marginTop={12}>
              ...
              </View>
                {
                  ...
                  <HStack gap={'$1'} my={'$1.5'} mx={'$3'}>
                    ...
                    <Text size='xs' color='$textLight200'>{errors.email}</Text>
                  </HStack>
                }
              </VStack>
              <VStack gap={'$1.5'} mx={'$1.5'}>
              <View marginTop={12}>
              ...
              </View>
                {
                  ...
                  <HStack gap={'$1'} my={'$1.5'} mx={'$3'}>
                    ...
                    <Text size='xs' color='$textLight200'>{errors.phoneNumber}</Text>
                  </HStack>
                }
              </VStack>
              <VStack gap={'$1.5'} mx={'$1.5'}>
              <View marginTop={12}>
              ...
              </View>
                {
                  ...
                  <HStack gap={'$1'} my={'$1.5'} mx={'$3'}>
                    ...
                    <Text size='xs' color='$textLight200'>{errors.password}</Text>
                  </HStack>
                }
              </VStack>
