...
const Article = (props: Props) => {
  ...
  return (
    <TabsPageContainer>
      ...
      <VStack>
        <Text fontWeight='900' mt={20}>
          الزراعه وفائدتها علي البشر
        </Text>
        <Text mt={20}>
          {" "}
          النباتات، تلك الكائنات الحية الرائعة التي تملأ كوكب الأرض بالحياة
          والجمال. تشكل النباتات جزءًا لا يتجزأ من البيئة الطبيعية وتلعب دورًا
          حيويًا في دعم حياة الكائنات الأخرى، بالإضافة إلى فوائدها الصحية
          والجمالية للإنسان. دور النباتات في البيئة: التنفس النباتي: تعتبر
          النباتات مصدرًا رئيسيًا للأكسجين في الغلاف الجوي، حيث تستخدم آلية
          التنفس النباتي لامتصاص ثاني أكسيد الكربون وإطلاق الأكسجين. تحسين جودة
          الهواء: تمتص النباتات ملوثات الهواء مثل ثاني أكسيد الكربون والمركبات
          العضوية الطائلة، مما يساهم في تنقية الهواء وتحسين جودته. محافظة التربة
          والحفاظ على التوازن البيئي: تساهم النباتات في تثبيت التربة ومنع التآكل
          والتصحر، بالإضافة إلى توفير موطن للكائنات الحية الأخرى والحفاظ على
          التوازن البيئي.
        </Text>
        <VStack my={10}>
        ...
        <Text>
          لقراءه المقال كاملا يرجي الذهاب الي <Text>sss</Text>
        </Text>
      </VStack>
    </TabsPageContainer>
  );
