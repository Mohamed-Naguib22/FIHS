...
const Peats = (props: Props) => {
  ...
  return (<TabsPageContainer>
    <View>
        <Text fontWeight='700' fontSize={20} pt={9} pb={15} color='#000'> الأفات</Text>
        <VStack justifyContent='space-between' alignItems='center' gap={10}>
            <HStack justifyContent='space-between' alignItems='center' gap={18}>
            <TouchableOpacity activeOpacity={1} style={{backgroundColor:"rgba(fff, fff,fff,0.9)",borderRadius:10,height:165,width:150 ,borderColor:'rgba(41, 133, 120,0.4)', borderWidth:1}} onPress={()=>router.push('/diseasesType/pests/[id]/')}>
                ...
                <Text textAlign='center' color='#000' fontWeight='700' >الكوليراا</Text>
                </VStack>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={1} style={{backgroundColor:"rgba(fff, fff,fff,0.9)",borderRadius:10,height:165,width:150 ,borderColor:'rgba(41, 133, 120,0.4)', borderWidth:1}} onPress={()=>router.push('/')}>
                <Image style={styles.plantDiseasesImage} source={require("@/assets/images/PlantDiseases.jpg")}/>
                <VStack justifyContent='center' alignItems='flex-end' pr={6}>
