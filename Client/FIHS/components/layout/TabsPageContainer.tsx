...
const TabsPageContainer = ({ refreshAction, children }: Props) => {
  ...
  return (
    <RefreshControl colors={["#298578"]} onRefresh={refreshAction} flex={1}>
      <ScrollView
        onScrollEndDrag={(e) => {
      ...
      <Fab
        ...
        h={60}
      >
        <Switch value={showSecondDiv} onValueChange={toggleSecondDiv} />
      </Fab>
      {showSecondDiv && (
        <View
          style={{
